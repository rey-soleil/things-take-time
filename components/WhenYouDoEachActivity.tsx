...
/*
 * The WhenYouDoEachActivity page allows the user to see when they tend to do each activity on their calendar.
 * Users select an activity from a dropdown, and the page displays a heatmap of when they tend to do that activity.
 */
export default function WhenYouDoEachActivity() {
